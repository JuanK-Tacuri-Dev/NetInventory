...
public class CreateProductRequest : IValidatableObject
{
    ...
    [MinLength(2, ErrorMessage = "El SKU debe tener al menos 2 caracteres.")]
    [MaxLength(50, ErrorMessage = "El SKU no puede superar 50 caracteres.")]
    [NoWhitespace(ErrorMessage = "El SKU no puede contener solo espacios.")]
    [SkuFormat(ErrorMessage = "El SKU solo puede contener letras, números, guiones (-) y guiones bajos (_).")]
