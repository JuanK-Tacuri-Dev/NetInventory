...
public sealed class CreateProductCommandHandlerTests
{
    ...
    public async Task HandleAsync_WithValidCommand_ReturnsSuccessWithProductDto()
    {
        ...
        _productRepo.Setup(r => r.ExistsBySkuAsync("SKU-001", null, It.IsAny<CancellationToken>())).ReturnsAsync(false);
        ...
        var command = new CreateProductCommand("Widget", "SKU-001", "Electronics", 9.99m);
    ...
    {
        _productRepo.Setup(r => r.ExistsBySkuAsync("SKU-001", null, It.IsAny<CancellationToken>())).ReturnsAsync(true);
    ...
    {
        var command = new CreateProductCommand("Widget", "", "Electronics", 9.99m);
        var handler = CreateHandler();
